# WS2812FX_web_GRBW
<b>Web Interface for RGBW & GRBW Strips WS2812FX for Arduino, with range controls and 4 colors leds.</b>
...
<li>Extract all files to your Arduino projects in directory named "ESP32_GRBW_Webinterface".</li>
</ul>
